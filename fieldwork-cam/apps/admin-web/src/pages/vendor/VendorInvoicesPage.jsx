...
export default function VendorInvoicesPage() {
  ...
  const handleExport = () => {
    const rows = filteredInvoices.map((invoice) => ({
      ...
      dueDate: invoice.dueDate ? formatShortDate(invoice.dueDate) : "",
    ...
    link.href = url;
    link.download = "vendor-invoices.csv";
    link.click();
  ...
  const statusChip = (invoice) => {
    ...
    const toneMap = {
      ...
      OVERDUE: { bg: "#FEE2E2", color: "#DC2626", label: "Overdue", dot: "#EF4444" },
    };

    const effectiveStatus = isOverdue(invoice) ? "OVERDUE" : status;
    const tone = toneMap[effectiveStatus] || {
      bg: "#F3F4F6",
      color: "#6B7280",
    ...
    >
      <Box sx={{ maxWidth: 1240 }}>
        ...
        <Typography sx={{ mt: 0.45, color: "#9CA3AF", fontSize: 13, fontWeight: 500 }}>
          Track only the invoices assigned to your vendor account.
        </Typography>
                ...
                <Table>
                  <TableHead>
                    ...
                    >
                      ...
                      <TableCell sx={tableHeadCellSx}>PAID ON</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {filteredInvoices.map((invoice) => (
                      ...
                      >
                        ...
                        <TableCell sx={tableBodyCellSx}>{statusChip(invoice)}</TableCell>
                        <TableCell sx={tableBodyCellSx}>
